define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'scanwork/product/index' + location.search,
                    add_url: 'scanwork/product/add',
                    edit_url: 'scanwork/product/edit',
                    del_url: 'scanwork/product/del',
                    multi_url: 'scanwork/product/multi',
                    table: 'product',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'name', title: __('产品名称'), align: 'left'},
                        {field: 'specification', title: __('产品规格'), align: 'left'},
                        {field: 'remark', title: __('备注'), align: 'left'},
