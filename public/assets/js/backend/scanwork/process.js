define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'scanwork/process/index' + location.search,
                    add_url: 'scanwork/process/add',
                    edit_url: 'scanwork/process/edit',
                    del_url: 'scanwork/process/del',
                    multi_url: 'scanwork/process/multi',
                    table: 'process',
                }
            });
